...
return [
    ...
    'license' => [
        ...
        'label'               => [
            'license_code' => 'Secret Code From JonathanZefanya',
        ]
    ],
    'site'        => [
    ...
    'installed'   => [
        'success_log_message' => 'GenZ installer successfully INSTALLED on ',
        'update_log_message'  => 'GenZ Installer successfully UPDATED on ',
    ],
];
